    ...
    return(
      <Grid className="dropnav">
        <Row>
          ...
          <Col id="nav-right" xs={4}><input id="inputsearch2" className="search-bar" onKeyPress={this.handleKeyPress} type="text"></input><Link to ="/"><img src="/media/search_black.svg"></img></Link></Col>
        </Row>
      </Grid>
    );
  }
